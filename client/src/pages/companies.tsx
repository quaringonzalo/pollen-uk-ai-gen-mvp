                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="ml-auto flex items-center gap-1">
                        ...
                        <span className="text-sm font-medium" style={{fontFamily: 'Poppins'}}>{company.rating}★ candidate rating</span>
                      </div>
                    </div>
                ...
                <CardContent className="p-3 sm:p-6">
                  <div className="space-y-2 mb-3 sm:mb-4">
                    ...
                    <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600" style={{fontFamily: 'Poppins'}}>
                      ...
                      <span>{company.rating}★ candidate rating • {company.openRoles} open roles</span>
                    </div>
                  </div>
